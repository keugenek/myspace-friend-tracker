...
export default function CreateFriend(): React.JSX.Element {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.post(route('friends.store'), submitData, {
            onError: (errors) => {
                setErrors(errors);
                setProcessing(false);
            },
        ...
        <AppLayout>
            <div className="myspace-container">
                <div className="myspace-header">
                    <h1 className="myspace-title">Add New Friend</h1>
                    <p className="myspace-subtitle">Tell me about your awesome friend! 🌟</p>
                </div>
                    ...
                    <form onSubmit={handleSubmit} className="friend-form">
                        ...
                        <div className="form-actions">
                            ...
                            <Button
                                ...
                                disabled={processing}
                            >
                                {processing ? 'Adding Friend...' : '✨ Add Friend'}
                            </Button>
                        </div>
                    </form>
                </div>
